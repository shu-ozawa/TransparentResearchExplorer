...
from backend.api.endpoints import research_tree as research_tree_router # Import the research tree router
...
app.include_router(research_tree_router.router, prefix="/api", tags=["Research Tree"])
